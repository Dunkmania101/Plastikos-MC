...
public class PlastikosControlItemRegistry extends BasePlastikosItemRegistryHandler {
    ...
    public Entry<ResourceLocation, Supplier<BlockItem>> WIRELESS_ANTENNA;

    @Override
    public void registerObjects() {
        // BlockItems
        this.WIRELESS_ANTENNA = this.registerObject("wireless_antenna", () -> new BlockItem(PlastikosMod.INSTANCE.CONTROL.BLOCKS.WIRELESS_ANTENNA.getValue().get(), getBaseProperties()));
